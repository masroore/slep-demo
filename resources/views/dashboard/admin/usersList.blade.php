                        ...
                        <tbody>
                          @foreach($users as $user)
                            <tr>
                              ...
                              <td>
                                <a href="{{ url('/users/' . $user->id) }}" class="btn btn-block btn-primary">{{ __('coreuiforms.view') }}</a>
                              </td>
                              <td>
                                <a href="{{ url('/users/' . $user->id . '/edit') }}" class="btn btn-block btn-primary">{{ __('coreuiforms.edit') }}</a>
                              </td>
                              <td>
                                @if( $you->id !== $user->id )
