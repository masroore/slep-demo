            ...
            <div class="fade-in">
                ...
                <div class="col-sm-6 col-lg-3">
                  <div class="card text-white bg-primary">
                    <div class="card-body pb-0">
                      ...
                      <div>{{ __('dashboard.members_online') }}</div>
                    </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    <div class="col-sm-5">
                      <h4 class="card-title mb-0">{{ __('dashboard.Traffic') }}</h4>
                      <div class="small text-muted">{{ __('dashboard.september') }} 2019</div>
                    </div>
                    <!-- /.col-->
                    <div class="col-sm-7 d-none d-md-block">
                      ...
                      <div class="btn-group btn-group-toggle float-right mr-3" data-toggle="buttons">
                        <label class="btn btn-outline-secondary">
                          <input id="option1" type="radio" name="options" autocomplete="off"> {{ __('dashboard.day') }}
                        </label>
                        <label class="btn btn-outline-secondary active">
                          <input id="option2" type="radio" name="options" autocomplete="off" checked=""> {{ __('dashboard.month') }}
                        </label>
                        <label class="btn btn-outline-secondary">
                          <input id="option3" type="radio" name="options" autocomplete="off"> {{ __('dashboard.year') }}
                        </label>
                      </div>
                    </div>
                    <!-- /.col-->
                ...
                <div class="card-footer">
                  <div class="row text-center">
                    <div class="col-sm-12 col-md mb-sm-2 mb-0">
                      <div class="text-muted">{{ __('dashboard.visits') }}</div><strong>29.703 {{ __('dashboard.users') }} (40%)</strong>
                      <div class="progress progress-xs mt-2">
                        <div class="progress-bar bg-success" role="progressbar" style="width: 40%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                    </div>
                    <div class="col-sm-12 col-md mb-sm-2 mb-0">
                      <div class="text-muted">{{ __('dashboard.unique') }}</div><strong>24.093 {{ __('dashboard.users') }} (20%)</strong>
                      <div class="progress progress-xs mt-2">
                        <div class="progress-bar bg-info" role="progressbar" style="width: 20%" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                    </div>
                    <div class="col-sm-12 col-md mb-sm-2 mb-0">
                      <div class="text-muted">{{ __('dashboard.pageviews') }}</div><strong>78.706 {{ __('dashboard.users') }} (60%)</strong>
                      <div class="progress progress-xs mt-2">
                        <div class="progress-bar bg-warning" role="progressbar" style="width: 60%" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                    </div>
                    <div class="col-sm-12 col-md mb-sm-2 mb-0">
                      <div class="text-muted">{{ __('dashboard.new_users') }}</div><strong>22.123 {{ __('dashboard.users') }} (80%)</strong>
                      <div class="progress progress-xs mt-2">
                        <div class="progress-bar bg-danger" role="progressbar" style="width: 80%" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                    </div>
                    <div class="col-sm-12 col-md mb-sm-2 mb-0">
                      <div class="text-muted">{{ __('dashboard.bounce_rate') }}</div><strong>40.15%</strong>
                      <div class="progress progress-xs mt-2">
                  ...
                  <div class="card">
                    ...
                    <div class="card-body row text-center">
                      <div class="col">
                        ...
                        <div class="text-uppercase text-muted small">{{ __('dashboard.friends') }}</div>
                      </div>
                      <div class="c-vr"></div>
                      <div class="col">
                        <div class="text-value-xl">459</div>
                        <div class="text-uppercase text-muted small">{{ __('dashboard.feeds') }}</div>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body row text-center">
                      <div class="col">
                        ...
                        <div class="text-uppercase text-muted small">{{ __('dashboard.followers') }}</div>
                      </div>
                      <div class="c-vr"></div>
                      <div class="col">
                        <div class="text-value-xl">1.792</div>
                        <div class="text-uppercase text-muted small">{{ __('dashboard.tweets') }}</div>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body row text-center">
                      <div class="col">
                        ...
                        <div class="text-uppercase text-muted small">{{ __('dashboard.contacts') }}</div>
                      </div>
                      <div class="c-vr"></div>
                      <div class="col">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="card">
                    <div class="card-header">{{ __('dashboard.traffic_&_sales') }}</div>
                    <div class="card-body">
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="row">
                          ...
                          <div class="progress-group mb-4">
                            <div class="progress-group-prepend"><span class="progress-group-text">{{ __('days.monday') }}</span></div>
                          ...
                          <div class="progress-group mb-4">
                            <div class="progress-group-prepend"><span class="progress-group-text">{{ __('days.tuesday') }}</span></div>
                            <div class="progress-group-bars">
                              <div class="progress progress-xs">
                          ...
                          <div class="progress-group mb-4">
                            <div class="progress-group-prepend"><span class="progress-group-text">{{ __('days.wednesday') }}</span></div>
                            <div class="progress-group-bars">
                              <div class="progress progress-xs">
                          ...
                          <div class="progress-group mb-4">
                            <div class="progress-group-prepend"><span class="progress-group-text">{{ __('days.thursday') }}</span></div>
                            <div class="progress-group-bars">
                              <div class="progress progress-xs">
                          ...
                          <div class="progress-group mb-4">
                            <div class="progress-group-prepend"><span class="progress-group-text">{{ __('days.friday') }}</span></div>
                            <div class="progress-group-bars">
                              <div class="progress progress-xs">
                          ...
                          <div class="progress-group mb-4">
                            <div class="progress-group-prepend"><span class="progress-group-text">{{ __('days.saturday') }}</span></div>
                            <div class="progress-group-bars">
                              <div class="progress progress-xs">
                          ...
                          <div class="progress-group mb-4">
                            <div class="progress-group-prepend"><span class="progress-group-text">{{ __('days.sunday') }}</span></div>
                            <div class="progress-group-bars">
                              <div class="progress progress-xs">
                        ...
                        <div class="col-sm-6">
                          ...
                          <div class="progress-group">
                            <div class="progress-group-header align-items-end">
                              ...
                              <div>{{ __('dashboard.organic_search') }}</div>
                      ...
                      <table class="table table-responsive-sm table-hover table-outline mb-0">
                        <thead class="thead-light">
                          <tr>
                            ...
                            <th>{{ __('dashboard.usage') }}</th>
                            <th class="text-center">{{ __('dashboard.payment_method') }}</th>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              ...
                              <div class="small text-muted"><span>{{ __('dashboard.new') }}</span> | {{ __('dashboard.registered') }}: Jan 1, 2015</div>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <div class="small text-muted"><span>{{ __('dashboard.recurring') }}</span> | {{ __('dashboard.registered') }}: Jan 1, 2015</div>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="small text-muted">{{ __('dashboard.last_login') }}</div><strong>{{ __('dashboard.time.yesterday') }}</strong>
                            </td>
                          </tr>
                        </tbody>
                      </table>
